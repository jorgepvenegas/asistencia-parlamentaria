...
Relevant Records:
- [[astro-server-fetch-to-react-client-load]] — consequence of API being edge-only
- [[monorepo-pnpm-workspaces-four-packages]] — api is one of four packages
- [[turso-libsql-database-backend]] — the storage layer Drizzle connects to
- [[zod-schemas-validate-api-responses]] — responses produced by this layer are the boundary being validated
- [[security-by-framework-defaults]] — Hono CORS and Drizzle prepared statements are the security surface
